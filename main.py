	...
	await event.reply_photo("https://telegra.ph/file/165941ae764a56d6d9c89.jpg",
                                ...
                                reply_markup=InlineKeyboardMarkup([
                                    [InlineKeyboardButton("Our Channel", url="https://t.me/KGNOFFICIAL"),
                                     InlineKeyboardButton("Creator", url="https://t.me/KGN_OFFICIAL")],
...
async def help_handler(_, event: Message):
    ...
    await event.reply_text(Config.ABOUT_HELP_TEXT.format(event.from_user.mention),
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("Our Channel", url="https://t.me/+87nVca8N8Qg2MTU1"),
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("About", callback_data="About_msg"),
						InlineKeyboardButton("Our Channel", url="KGNOFFICIAL ")
					], 
                                        [
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
						InlineKeyboardButton("Support", url="https://t.me/KGN_SUPPORT_BOT"),
						InlineKeyboardButton("Channel", url="https://t.me/+87nVca8N8Qg2MTU1")
					]
				]
			),
			parse_mode="html"
